...
openssl req -passin pass:123456 -new -x509 -days 365 -key ca.key -out ca.crt -subj "/C=CN/ST=SC/L=CD/O=XY Inc./OU=rannuo/CN=rannuo.cn"

echo Generate server key:
openssl genrsa -passout pass:123456 -out server.key 2048

echo Generate server signing request:
openssl req -passin pass:123456 -new -key server.key -out server.csr -subj "/C=CN/ST=SC/L=CD/O=XY Inc./OU=rannuo/CN=rannuo.cn"
...
openssl req -passin pass:123456 -new -key client.key -out client.csr -subj "/C=CN/ST=SC/L=CD/O=XY Inc./OU=rannuo/CN=rannuo.cn"
